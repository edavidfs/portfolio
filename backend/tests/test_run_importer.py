...
from api.main import run_importer, get_connection, ensure_schema, get_db_path, ensure_db_ready  # noqa: E402
...
def test_run_importer_transfers_fx_and_ignore_stk(monkeypatch, tmp_path):
  ...
  assert any(r[0] == "FX:EUR.USD:1" and r[1] == "fx_interno" for r in results)
